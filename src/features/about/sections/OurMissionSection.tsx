        ...
        <StaggerContainer className="flex w-full flex-col gap-6 lg:flex-1">
          <StaggerItem>
            <svg
              ...
              aria-hidden="true"
            >
              <circle cx="22" cy="26" r="17" stroke="#161C2D" strokeWidth="2" />
              <circle cx="22" cy="26" r="11" stroke="#161C2D" strokeWidth="2" />
              <circle cx="22" cy="26" r="5" stroke="#161C2D" strokeWidth="2" />
              <path
                d="M22 26L36 12"
                stroke="#161C2D"
                strokeWidth="2"
        ...
        <StaggerItem className="w-full lg:w-[498px] lg:shrink-0">
          <div className="relative mx-auto w-full max-w-[498px]">
            ...
            <Image
              ...
              width={140}
              height={140}
              className="pointer-events-none absolute -right-8 -top-8 z-0 h-auto w-[140px] select-none"
            />

            {/* Coral circle accent — bottom right, behind image */}
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -bottom-10 -right-10 z-0 rounded-full bg-[#F64B4B]/57"

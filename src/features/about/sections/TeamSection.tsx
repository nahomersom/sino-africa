      ...
      <div className="relative z-10 flex w-full flex-col items-center gap-10">
        ...
        <div className="flex w-full max-w-[734px] gap-1.5 rounded-2xl bg-white p-4">
          ...
          <div className="flex flex-1 flex-col justify-end gap-1.5 rounded-[32px] px-4 py-6">
            <h3 className="text-[40px] font-normal leading-[1.5] text-text-100">
              {ceo.name}
            </h3>
        ...
        <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
          {managers.map((member) => (
            <div
              key={member.name}
              className="relative flex h-[333px] w-[266px] shrink-0 flex-col justify-end overflow-hidden rounded-lg p-4"
            >
              <Image
                src={member.image}
                alt={member.name}

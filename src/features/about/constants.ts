export const aboutContent = {
  ...
  team: {
    ...
    staff: [
      { name: "Marta T.", role: "Software Engineer", image: "/images/about/team/staff-1.png" },
      { name: "Abebe K.", role: "Product Manager", image: "/images/about/team/staff-2.png" },
      { name: "Hana D.", role: "UX/UI Designer", image: "/images/about/team/staff-3.png" },
      { name: "Solomon A.", role: "Data Analyst", image: "/images/about/team/staff-4.png" },
      { name: "Liya N.", role: "Marketing Specialist", image: "/images/about/team/staff-5.png" },
      { name: "Kebede A.", role: "Business Analyst", image: "/images/about/team/staff-6.png" },
      { name: "Meron T.", role: "Content Strategist", image: "/images/about/team/staff-7.png" },
      { name: "Tsehay A.", role: "Graphic Designer", image: "/images/about/team/staff-8.png" },
      { name: "Biruk M.", role: "System Administrator", image: "/images/about/team/staff-9.png" },
      { name: "Nardos E.", role: "Sales Executive", image: "/images/about/team/staff-10.png" },
    ],
  },
  contact: {
